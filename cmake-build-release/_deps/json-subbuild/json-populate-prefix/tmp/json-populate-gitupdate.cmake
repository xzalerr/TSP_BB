...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v3.10.4"
  WORKING_DIRECTORY "/Users/rafalzalecki/CLionProjects/TSP_BB/cmake-build-release/_deps/json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/rafalzalecki/CLionProjects/TSP_BB/cmake-build-release/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/rafalzalecki/CLionProjects/TSP_BB/cmake-build-release/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
